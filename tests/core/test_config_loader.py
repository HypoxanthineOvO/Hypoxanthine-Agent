...
def test_repo_models_config_routes_fast_tool_model_and_local_utility_models() -> None:
    ...
    assert runtime.task_routing["audio"] == "MimoV25TTS"
    assert runtime.task_routing["tts"] == "MimoV25TTS"
    ...
    assert runtime.models["MimoV2Omni"].type == "vision"
    assert runtime.models["MimoV2Omni"].fallback == "DashscopeQwenVLPlus"
    assert runtime.models["DashscopeQwenVLPlus"].type == "vision"
    assert runtime.models["DashscopeQwenVLPlus"].litellm_model == "openai/qwen-vl-plus-latest"
    assert runtime.models["DashscopeQwenVLPlus"].fallback == "DashscopeQwen3VLFlash"
    assert runtime.models["DashscopeQwen3VLFlash"].type == "vision"
    assert runtime.models["DashscopeQwen3VLFlash"].litellm_model == "openai/qwen3-vl-flash"
    assert runtime.models["DashscopeQwen3VLFlash"].fallback == "MimoV25VisionFlash"
    assert runtime.models["MimoV25VisionFlash"].type == "vision"
    assert runtime.models["MimoV25VisionFlash"].litellm_model == "openai/mimo-v2.5"
    assert runtime.models["MimoV25VisionFlash"].fallback is None
    assert runtime.models["MimoV25TTS"].type == "audio"
    assert runtime.models["MimoV25TTS"].fallback == "MimoV2TTS"
    assert runtime.models["MimoV25TTSVoiceClone"].type == "audio"
    assert runtime.models["MimoV25TTSVoiceClone"].fallback == "MimoV25TTS"
    assert runtime.models["MimoV25TTSVoiceDesign"].type == "audio"
    assert runtime.models["MimoV25TTSVoiceDesign"].fallback == "MimoV25TTS"
    assert runtime.models["MimoV2TTS"].type == "audio"
